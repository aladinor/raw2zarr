...
def nexrad_aws_file_sweep10_misaligned(tmp_path_factory):
    ...
    """
    aws_url = "s3://unidata-nexrad-level2/2023/06/29/KILX/KILX20230629_154426_V06"
...
def nexrad_local_uncompressed_file(tmp_path_factory):
    ...
    """
    aws_url = "s3://unidata-nexrad-level2/2012/01/29/KVNX/KVNX20120129_000840_V06.gz"
...
def nexrad_local_gz_files(tmp_path_factory):
    ...
    """
    s3_urls = [
        "s3://unidata-nexrad-level2/2012/01/29/KVNX/KVNX20120129_000840_V06.gz",
        "s3://unidata-nexrad-level2/2012/01/29/KVNX/KVNX20120129_180249_V06.gz",
    ]
...
def nexrad_s3_file(tmp_path_factory):
    ...
    """
    return "s3://unidata-nexrad-level2/2012/01/29/KVNX/KVNX20120129_000840_V06.gz"
...
def nexrad_aws_file_SAILS(tmp_path_factory):
    ...
    Download a NEXRAD radar file from AWS S3 to a temporary directory for testing.
    """
    aws_url = "s3://unidata-nexrad-level2/2023/06/29/KILX/KILX20230629_161526_V06"
...
def iris_aws_file():
    ...
    """
    return (
        "s3://unidata-nexrad-level2/l2_data/2022/06/01/Guaviare/GUA220601112817.RAWP3AL"
    )
