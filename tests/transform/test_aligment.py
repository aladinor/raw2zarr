...
class TestAlignment:
    @pytest.mark.slow
    def test_fix_angle_on_misaligned_sweep10(self, nexrad_aws_file_sweep10_misaligned):
        dtree = load_radar_data(
            nexrad_aws_file_sweep10_misaligned, engine="nexradlevel2"
        )
